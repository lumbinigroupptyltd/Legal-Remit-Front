export const ON_PRESS_SECURITY_SYSTEM = "recieverReducer/ON_PRESS_SECURITY_SYSTEM";
export const ON_PRESS_MAIN_GATE = "recieverReducer/ON_PRESS_MAIN_GATE";
export const ON_PRESS_SWITCH_BOARD_BUTTON =
  "recieverReducer/ON_PRESS_SWITCH_BOARD_BUTTON";
export const ON_PRESS_OUT_SWITCH_BOARD_BUTTON =
  "recieverReducer/ON_PRESS_OUT_SWITCH_BOARD_BUTTON";
export const ON_PRESS_APPLIENCES_SWITCH_BOARD_BUTTON =
  "recieverReducer/ON_PRESS_APPLIENCES_SWITCH_BOARD_BUTTON";
export const ON_SWITCH_BOARD_DROPDOWN = "recieverReducer/ON_SWITCH_BOARD_DROPDOWN";
export const ON_ONPRESS_OUT_DOOR_DROPDOWN =
  "recieverReducer/ON_ONPRESS_OUT_DOOR_DROPDOWN";
export const ON_ONPRESS_SWITCH_ON_ALL_OUT =
  "recieverReducer/ON_ONPRESS_SWITCH_ON_ALL_OUT";
export const ON_ONPRESS_SWITCH_OFF_ALL_OUT =
  "recieverReducer/ON_ONPRESS_SWITCH_OFF_ALL_OUT";
export const ON_ONPRESS_SWITCH_ON_ALL_IN =
  "recieverReducer/ON_ONPRESS_SWITCH_ON_ALL_IN";
export const ON_ONPRESS_SWITCH_OFF_ALL_IN =
  "recieverReducer/ON_ONPRESS_SWITCH_OFF_ALL_IN";
