              ...
              <a>
                <div className="media">
                  ...
                  <div className="media-body">
                    <span className="name">
                      Chris Fox <small className="responsiveFontLarge  float-right">Just now</small>
                    </span>
              ...
              <a>
                <div className="media">
                  ...
                  <div className="media-body">
                    <span className="name">
                      Joge Lucky{" "}
                      <small className="responsiveFontLarge  float-right">38 minutes ago</small>
                    </span>
                    <span className="message">
              ...
              <a>
                <div className="media">
                  ...
                  <div className="media-body">
                    <span className="name">
                      Isabella{" "}
                      <small className="responsiveFontLarge  float-right">2 hours ago</small>
                    </span>
                    <span className="message">
              ...
              <a>
                <div className="media">
                  ...
                  <div className="media-body">
                    <span className="name">
                      Folisise Chosielie{" "}
                      <small className="responsiveFontLarge  float-right">32 hours ago</small>
                    </span>
                    <span className="message">
            ...
            <li className="online">
              <a>
                <div className="media">
                  ...
                  <div className="media-body">
                    <span className="name">
                      Alexander <small className="responsiveFontLarge  float-right">1 day ago</small>
                    </span>
                    <span className="message">
