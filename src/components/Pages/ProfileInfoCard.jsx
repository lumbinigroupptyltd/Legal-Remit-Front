  ...
  render() {
    return (
      <div className="card">
        ...
        <div className="body">
          <small className="responsiveFontLarge  text-muted">Address: </small>
          <p>795 Folsom Ave, Suite 600 San Francisco, 94107</p>
          <div></div>
          <hr />
          <small className="responsiveFontLarge  text-muted">Email address: </small>
          <p>michael@gmail.com</p>
          <hr />
          <small className="responsiveFontLarge  text-muted">Mobile: </small>
          <p>+ 202-555-2828</p>
          <hr />
          <small className="responsiveFontLarge  text-muted">Birth Date: </small>
          <p className="m-b-0">October 22th, 1990</p>
          <hr />
          <small className="responsiveFontLarge  text-muted">Social: </small>
          <p>
