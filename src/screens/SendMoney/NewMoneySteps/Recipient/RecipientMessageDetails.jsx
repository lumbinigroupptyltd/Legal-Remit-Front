...
const RecipientMessageDetails = ({ onFormValidate, onClose }) => {
    const theme = useTheme();
  const { formik } = useAddRecipientMessageDetails(onFormValidate, onClose);
...
export default RecipientMessageDetails;
