...
import "../ReVerifyIDDocument/ReverifyIdDocument.css";
...
const KYCuploadDocuments = ({imageData ,I_UserIdType }) => {
    ...
    useEffect(() => {
      setstep5value(selectedImagesFront)
        ...
        imageData(selectedFileImagesFront.concat(selectedFileImagesBack))
        
    }, [selectedImagesFront, selectedImagesBack,I_UserIdType])
  
    // console.log(I_UserIdType,"I_UserIdType2")
    ...
    if(I_UserIdType == ""){
      ...
      if (file) {
        ...
        // Check file type
        const allowedExtensions = I_UserIdType == 7991 ? ['.png', '.jpg', '.jpeg', '.pdf']:['.png', '.jpg', '.jpeg'];
    ...
    // console.log(I_UserIdType,"456789")
    ...
    return (
      <>
        <Row className="d-flex respoChildFooter">
            ...
            <div id="IdDocument">
              <Row>
                ...
                <Col className="col-lg-12 p-3">
                  <div id={I_UserIdType == 7991 ? 'dropzone1':"dropzone"}>
                    <div className={`text-black ${I_UserIdType == 7991 ? "drp22" :"drp11"}`}>
          ...
          <Col className={I_UserIdType == 7991 ? 'd-none' : 'd-block'}>
              ...
              <Row className="d-flex">
                ...
                <Col className=" col-lg-12 p-3">
                  <div id="dropzone">
                    ...
                    <input type="file" id="imagesBack" className="required" name="images" onChange={onSelectFileBack} accept="image/png , image/jpeg, image/jpg, application/pdf" /> {/*/accept="image/png , image/jpeg, image/jpg, application/pdf"*/ }
                  </div>
                </Col>
                      ...
                      return (
                        <div key={image} className="image position relative">
                          <div className="img-box effect-image-1">
                            <img src={image} height="100" width="200" className="hoverView uploadedImage roundedCorner" alt="upload" />
                            <div class="overlay simple-overlay roundedCorner">
                            <div className="mainBtnClose" onClick={() => deleteHandlerBack(image,index)}>
        ...
        <ModalComponent
            ...
            title1={I_UserIdType == 7991 ? "Invalid file type , Only PNG, JPG, PDF and JPEG files are allowed." : "Invalid file type , Only PNG, JPG, and JPEG files are allowed."}
