...
export default function Step4 ({
	...
	const submitUserKyc = async () => {
		...
		validator.error_input_validation('Bussiness_KYC_step4')
								...
								<Row id="stepone3in1">
									...
									<Form id="Bussiness_KYC_step4">
										...
										<Row className="mb-3 respoChildFooter">
											<Form.Group
												as={Col}
												className="nationalityDRP input-container "
											>
												<i className="blueText nationalityMain3 	fa fa-flag svgNationality"></i>
												<Select
													name="nationality"
													options={nationalityList}
													className={`SelectValueSelect SelectValueSelect4 SelectHoverLabel required nationality ${isNationalityValid === false ? 'custom__error' : ''}  `}
										...
										<Row className="mb-3 respoChildFooter">
											...
											>
												...
												<Form.Control
													...
													value={streetName}
													name="streetName"
													className={`form-input formControlStep3  required ${
										...
										<Row className="mb-3 respoChildFooter">
											...
											>
												...
												<Form.Control
													...
													name="suburb"
													className="form-input formControlStep3 cityvalidation  required"
												/>
												<label htmlFor="name" className="form-label1">
													Suburb/City
												</label>
										...
										<Row className="mb-3 respoChildFooter">
											...
											>
												<i className="blueText mainStep3 fa fa-map-marker "></i>
												<Form.Select
													className=" required mainStep3Select formControlStep3 form-input"
													onChange={(e) => {
														handleUserKycDetail(e)
										...
										<Row className="mb-3 respoChildFooter">
											...
											>
												...
												<Select
													...
													className={`SelectValueSelect SelectValueSelect4 SelectHoverLabel required nationality ${isOccupationValid === false ? 'custom__error' : ''}`}
													closeMenuOnSelect={true}
													isSearchable={true}
													onChange={(e) => {
