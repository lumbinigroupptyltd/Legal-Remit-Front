...
// Format tomorrow's date as "yyyy-mm-dd"
	...
	const submitUserIdDetails = async () => {
		...
		validator.error_input_validation('Bussiness_id_Details_step5')
							...
							<div className="mt-3 pe-4 ps-4">
								<Row id="steptwo5in2">
									<Col className="col-lg-12 p-0">
											...
											<Row className="respoChildFooter">
												...
												>
													...
													<Select
														...
														${isIdTypeValid === false ? 'custom__error' : ''}
														`}
											...
											<Row className="mb-3 respoChildFooter">
												...
												>
													...
													<Form.Control
														...
														className="form-input purpleFormStep5 required "
													/>
											...
											<Row className="mb-3 respoChildFooter">
												...
												>
													...
													<Select
														...
														className={`SelectValueSelect99 SelectValueSelect5 SelectHoverLabel required nationality ${isIdAuthorityValid === false ? 'custom__error' : ''}`}
														closeMenuOnSelect={true}
														isSearchable={true}
														onChange={(e) => {
										...
										>
											<input
												className={`col-lg-3 uppercase pointer nextButtonStep5 `}
												type="button"
												value={'Next'}
