...
import Agent_File_Uploading from "../../../../Helpers/UploadFiles/Agent_File_Uploading";
import Business_File_Uploading from "../../../../Helpers/UploadFiles/Business_File_Uploading";
import axios from "axios";
import { CommonConstants } from "../../../../../Constants/common.constants";
import Loader from "../../../../Loader/Loader";
import ImageView from "../../../../Helpers/ImagePreview/ImageView";
                          ...
                          <Row className="mb-3 respoChildFooter">
                            <Col>
                              ...
                              <small className={`responsiveFontLarge text-primary error_message error_message_number ms-4 pointer 
                                  ${EditValue == true
                                      ? "d-block"
                                      : "d-none"}`} onClick={(e)=>{setFormPopup(true)}}>
                                  view director
                                </small>
                            </Col>
                            ...
                            <Col>
                              ...
                              <small className={`responsiveFontLarge text-primary error_message error_message_number ms-4 pointer
                                  ${EditValue == true
                                      ? "d-block"
                                      : "d-none"}`
                                      } onClick={(e)=>{setShareholderFormPopup(true)}}>
                                  view Shareholders
                                </small>
                            </Col>
                          </Row>
                        ...
                        <div key={i} className="my-3">
                          ...
                          <Row className="px-3 respoChildFooter">
                            <div className="d-flex justify-content-between pb-3 pt-1">
                              ...
                              <h5 className={`fs-6 ps-3 text-danger pointer ${formDataa.length < 2 ? "d-none" :"d-block"}`} onClick={(e)=>{UpdateremoveFieldsReciptionDetails(i)}}>remove</h5>
                            </div>
                            <Form.Group
                              as={Col}
                              className="left-inner-addon input-container"
                       ...
                       <Row>
                        <Col className="col-lg-12 d-flex m-auto justify-content-center">
                          <Button
                            className="d-block nextBtnDirector w-auto px-3"
                            variant="primary"
                            onClick={(e)=>{AddFieldShareHolder(e)}}
                          >
                            Add Director
                          </Button>
                        </Col>
