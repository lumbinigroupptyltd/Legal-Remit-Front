...
export default function TransactionViewPage(props) {
  ...
  const getUserByTransaction = async () => {
    try {
      ...
      setSelectedValue(userData.partnerBankName);
      setSelectedPurposeOfTransacfer(userData.transferPurpose);
      setSelectedPurposeOfTransacferId(userData.transferPurposeId);
      setDeliveryMethodId(userData.deliveryMethodId);
      setSelectedMethod(userData.deliveryMethodName);
      setPaymentNote(userData.paymentNote);
  ...
  const updateTransactin = async () => {
    let data = {
      id: props.location.state.id, //transaction id
      recipientId: recipientId,
      partnerBankId: partnerBankId,
      deliveryMethodId: deliveryMethodId,
      transferPurposeId: SelectedPurposeOfTransacferId,
